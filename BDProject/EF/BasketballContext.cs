...
namespace BDProject.EF
{
    ...
    public class BasketballContext : DbContext
    {
        ...
        public void Task4()
        {
            ...
            foreach (Team t in this.Teams)
            {
                int cnt = this.Games.Where(g => (g.CntVisitors > 10000) && (g.Team2.Name == t.Name || g.Team1.Name == t.Name)).Count();
                Console.WriteLine($"{t.Name} - {cnt}");
            }
        }
        public void Task5()
        ...
        public void Task6()
        {
            ...
            Console.WriteLine($"{t1} : {t2} {sc1} : {sc2}");
            ...
            Game g13 = new Game
            {
                ...
                Score1 = sc1,
                Score2 = sc2,
                Team1 = new Team { Name = t1 },
                Team2 = new Team { Name = t2 }
            };
